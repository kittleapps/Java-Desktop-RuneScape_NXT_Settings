...
public class Storage {
	...
	/* 
	 * These are made just in case the vt-varc keys change numeral values for ease-of-changing.
	 * 
	 */
	...
	public static String[][] GRAPHICS_OPTIONS = {
		 ...
		 * Each ID here will be used in the client starting from 0.
		 * 
		 */
		{ 
			/* Remove Roofs */
	...
	public static void init() {
		 ...
		 * Find+Save the Frame Rate iof the default device
		 * Load the dirver for the Sqlite3 library
		 * 
		 */
		OS_TYPE = -1;
